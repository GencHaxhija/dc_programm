...
SOURCES = \
	__init__.py \
	DC_Programm.py DC_Programm_dockwidget.py

PLUGINNAME = DC_Programm

PY_FILES = \
	__init__.py \
	DC_Programm.py DC_Programm_dockwidget.py

UI_FILES = DC_Programm_dockwidget_base.ui
...
QGISDIR=C:\Users\Genc Haxhija\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
